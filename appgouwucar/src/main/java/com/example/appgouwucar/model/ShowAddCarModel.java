...
public class ShowAddCarModel implements IShowAddCarModel {
    ...
    @Override
    public void showaddcar(Map<String, String> pams, final OnNetListener<AddcarBean> onNetListener) {
        OkHttpUtils.getOkHttpUtils().doPost("http://120.27.23.105/product/addCart", pams, new Callback() {
            @Override
